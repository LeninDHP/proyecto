...
if($_POST){
  ...
  e.apellido_empleado, f.fecha_fac, d.tipo_det, e.telefono, c.id_cliente
...
?>
                  ...
                  <td>
                   ...
                   <br>
                    ...
                    <form action="modificar_factura.php" method="post" id="form_ver">

                    <input type="hidden" value="<?php echo $dato['id_factura'];?>"  name="id_fac" id="id_fac">
                    <input type="hidden" value="<?php echo $dato['fecha_fac'];?>"  name="fecha_fac" id="fecha_fac">
                    <input type="hidden" value="<?php echo $dato['id_cliente'];?>"  name="id_cli" id="id_cli">
                    <input type="hidden" value="<?php echo $total;?>"  name="total" id="total">



                    <input type="submit" class="btn btn-primary" value="Guardar Factura" name="guardar" id="btn_ver">
                    <br>
                    </form>
                  
                  <form action= "detalle.php" class="form-inline hidden-print " method="post">
