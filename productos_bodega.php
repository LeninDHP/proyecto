    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="bodega.php.php">Bodega</a>
        </div>
      ...
      <div class="row">
         <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li  class="active"><a href="productos_bodega.php">Productos</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="negro">Registrar Nuevo Producto</h2>
           ...
           <div class="modal-body">
              <form action= "php/insertar_pro.php" class="form-inline" id="form_bod" method="post">
              ...
              <input type="submit" class="btn btn-primary" value="Ingresar" name="Registrar Empleado" id="btn">
            </div>
          </form>
        </div>
      </div>
